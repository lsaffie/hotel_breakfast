...
class BeValidXhtml
  ...
  MARKUP_VALIDATOR_HOST = ENV['MARKUP_VALIDATOR_HOST'] || 'validator.w3.org' unless defined? MARKUP_VALIDATOR_HOST
  MARKUP_VALIDATOR_PATH = ENV['MARKUP_VALIDATOR_PATH'] || '/check' unless defined? MARKUP_VALIDATOR_PATH
  CSS_VALIDATOR_HOST = ENV['CSS_VALIDATOR_HOST'] || 'jigsaw.w3.org' unless defined? CSS_VALIDATOR_HOST
  CSS_VALIDATOR_PATH = ENV['CSS_VALIDATOR_PATH'] || '/css-validator/validator' unless defined? CSS_VALIDATOR_PATH
